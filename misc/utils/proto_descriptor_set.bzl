# Taken from rules_proto because the google devs think this rule "wasnt used"
# See https://github.com/protocolbuffers/protobuf/issues/19647
#
# https://github.com/bazelbuild/rules_proto/blob/main/proto/private/rules/proto_descriptor_set.bzl
#
...
""".strip(),
        ...
        "_file_concat": attr.label(
            default = "//misc/utils/protobuf/file_concat",
            executable = True,
            cfg = "exec",
        ),
    },
